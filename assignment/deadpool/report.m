...
% This function takes a matrix of size 2 x N 
    ...
    fid = fopen('deadpool-1.md','w');
        ...
        fprintf(fid, 'X  |  Y');
        fprintf(fid, '\n');
        fprintf(fid, '%.2f %.2f' , data_print(1,1),data_print(1,2));
        fprintf(fid, '\n');
        fprintf(fid, '%.2f %.2f' , data_print(2,1),data_print(2,2));
        fprintf(fid, '\n');
        fprintf(fid, '%.2f %.2f' , data_print(3,1),data_print(3,2));
        fprintf(fid, '\n');
        fprintf(fid, '%.2f %.2f' , data_print(4,1),data_print(4,2));
        fprintf(fid, '\n');
        fprintf(fid, '%.2f %.2f' , data_print(5,1),data_print(5,2));
        fprintf(fid, '\n');
        fprintf(fid, '\n');
